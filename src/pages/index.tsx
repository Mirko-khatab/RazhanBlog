      ...
      <Container>
        <div className="flex flex-col  justify-center items-center ">
          <img
            ...
            alt="vandam uuuuuu"
          />
          <h3 className="text-2xl ml-3 text-white font-bold mt-5 flex-row flex justify-evenly  items-center">
            Razhan omed Osman{" "}
          ...
          <div className=" mt-20 mx-auto ">
            ...
            >
              <h2 className="text-gray-500 hover:text-gray-700 text-xl tracking-tight	">
          ...
          <div className=" mt-20 ">
            <div className="bg-gray-100 w-96  py-4 rounded-lg px-4 space-y-8">
              <div
